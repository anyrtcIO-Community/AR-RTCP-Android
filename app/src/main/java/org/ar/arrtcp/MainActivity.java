...
public class MainActivity extends BaseActivity {
    ...
    public int getLayoutId() {
        return org.ar.arrtcp.R.layout.activity_main;
    }

    @Override
    public void initView(Bundle savedInstanceState) {
        ImmersionBar.with(this).statusBarDarkFont(true,0.2f).init();
        findViewById(org.ar.arrtcp.R.id.tv_open_live).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(org.ar.arrtcp.R.id.tv_watch_live).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (AndPermission.hasPermissions(MainActivity.this, Permission.CAMERA, Permission.RECORD_AUDIO)) {
