...
public class ARVideoView implements View.OnTouchListener{
    ...
    protected static class VideoView {
        ...
        public VideoView(String videoId, Context ctx, EglBase eglBase, int index, int x, int y, int w, int h) {
            ...
            View view = View.inflate(ctx, org.ar.arrtcp.R.layout.layout_arvideo, null);//这个View可完全自定义 需要显示名字或者其他图标可以在里面加
            flLoading = (FrameLayout) view.findViewById(org.ar.arrtcp.R.id.fl_video_loading);
            surfaceViewRenderer = (SurfaceViewRenderer) view.findViewById(org.ar.arrtcp.R.id.sv_video_render);
